...
<body>
    ...
    <a href="searchPlus20.php?plus=20&departement=<?= $_GET['departement'] ?>&nameEmployee=<?= $_GET['nameEmployee'] ?>&PrenomEmployee=<?= $_GET['PrenomEmployee'] ?>&AgeMin=<?= $_GET['AgeMin'] ?>&AgeMax=<?= $_GET['AgeMax'] ?>">plus 20</a>
</body>
</html>